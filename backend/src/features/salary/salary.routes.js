...
// Structures
router.get('/structures', authorize('ADMIN', 'HR_PAYROLL_MANAGER', 'HR_PAYROLL_USER', 'HR_MANAGER'), (req, res, next) => salaryController.getStructures(req, res, next));
router.get('/structures/:id', authorize('ADMIN', 'HR_PAYROLL_MANAGER', 'HR_PAYROLL_USER', 'HR_MANAGER'), (req, res, next) => salaryController.getStructureById(req, res, next));
...
// Rules
router.get('/rules', authorize('ADMIN', 'HR_PAYROLL_MANAGER', 'HR_PAYROLL_USER', 'HR_MANAGER'), (req, res, next) => salaryController.getRules(req, res, next));
