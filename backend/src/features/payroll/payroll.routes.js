...
router.get('/', authorize('ADMIN', 'HR_PAYROLL_MANAGER', 'HR_PAYROLL_USER', 'HR_MANAGER'), (req, res, next) => payrollController.getAll(req, res, next));
...
router.get('/:id', authorize('ADMIN', 'HR_PAYROLL_MANAGER', 'HR_PAYROLL_USER', 'HR_MANAGER'), (req, res, next) => payrollController.getById(req, res, next));
